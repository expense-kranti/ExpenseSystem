...
public class RedisFilePointer extends BaseRedisDataAccessLayer implements IFilePointer {
	...
	public FileEntity save(FileEntity fileEntity) {
		...
		logger.logInfo("RedisFilePointer", "FileEntity.Save", "UserFileMapping",
				"Key=" + UserFile + fileEntity.getUserId().toUpperCase() + "Value=" + userFilesAsList.toString());
		...
		if (fileEntity.getOrganizationId() != null) {
			...
			if (organizationFilesAsXML == null) {
				...
				organizationFilesAsList = (BoilerplateList<String>) Base.fromXML(organizationFilesAsXML,
						BoilerplateList.class);
			}
	...
	public BoilerplateList<FileEntity> getAllFiles(String userId, String organizationId) {
		...
		if (organizationId != null) {
			...
			if (fileIdsForOrganizationXML != null) {
				fileIdsAsList.addAll(
						(BoilerplateList<String>) Base.fromXML(fileIdsForOrganizationXML, BoilerplateList.class));
			}
		}
	...
	public BoilerplateList<FileEntity> getFiles(String organizationId) {
		...
		if (fileIdsForOrganizationXML != null) {
			fileIdsAsList
					.addAll((BoilerplateList<String>) Base.fromXML(fileIdsForOrganizationXML, BoilerplateList.class));
		}
	...
	@Override
	public BoilerplateList<FileEntity> getAllFilesOnMasterTag(String userId, String fileMasterTag) {
		BoilerplateList<String> fileIdsAsList = new BoilerplateList<>();
