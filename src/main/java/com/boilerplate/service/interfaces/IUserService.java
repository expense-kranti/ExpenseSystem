...
public interface IUserService {
	 ...
	 *             This is thrown if the user already exists in the database for the
	 *             given provider
	...
	/**
	 * This method takes an authentication request and generates a session if the
	 ...
	 * 
	 * @param userId
	 *            The id of the user in format provider:userid, if no provider is
	 ...
	 * @param userId this parameter define the userId
	 ...
	 *            True if the user password to be encryptied into a message string
