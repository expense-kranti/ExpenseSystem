...
public class EmailUtility {
	 ...
	 */
	public static void send(BoilerplateList<String> tos, BoilerplateList<String> ccs, BoilerplateList<String> bccs,
		...
		mimeMessage.setFrom(
				new InternetAddress(properties.getProperty("SmtpFrom"), properties.getProperty("SmtpFromName")));
		for (Object to : tos) {
		...
		String host = (String) properties.get("SmptHost");
		host = (String) properties.get("SmtpUsername");
		host = (String) properties.get("SmtpPassword");
	...
	private static void loadProperties() {
		...
		try {
			...
			inputStream = EmailUtility.class.getClassLoader().getResourceAsStream("boilerplate.properties");
	 ...
	 *             The Exception
	 */
	public static BoilerplateList<MultipartFile> provideTopUnseenEmailAttachment(String userEmail, String password)
			throws Exception {
