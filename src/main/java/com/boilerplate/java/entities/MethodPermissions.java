...
public class MethodPermissions {
	...
	/**
	 * This tells if the user should be authenticated to execute the given
	 * method
	 */
	private boolean isAuthenticationRequired;

	// added for expense system by Ruchi

	/**
	 * This indicates whether approver role is required for this method to be
	 * executed
	 */
	private boolean isApproverRoleRequired;

	/**
	 * This indicates whether finance role is required for this method to be
	 * executed
	 */
	private boolean isFinanceRoleRequired;
	 ...
	 *            The value of authentication status.
	 */
	 ...
	 * 
	 * @param publishBusinessSubject
	 *            The publish business subject
	 */
	 ...
	 * 
	 * @param isPublishRequired
	 *            The isPublishRequired
	 */
	...
	/**
	 * this method is used isApproverRequired
	 * 
	 * @return
	 */
	public boolean getIsApproverRoleRequired() {
		return isApproverRoleRequired;
	}

	/**
	 * This method is used to set isApproverRoleRequired
	 * 
	 * @param isApproverRequired
	 */
	public void setIsApproverRoleRequired(boolean isApproverRoleRequired) {
		this.isApproverRoleRequired = isApproverRoleRequired;
	}

	/**
	 * This method is used to get isFinanceRoleRequired
	 * 
	 * @return
	 */
	public boolean getIsFinanceRoleRequired() {
		return isFinanceRoleRequired;
	}

	/**
	 * This method is used to set isFinanceRoleRequired
	 * 
	 * @param isFinanceRoleRequired
	 */
	public void setIsFinanceRoleRequired(boolean isFinanceRoleRequired) {
		this.isFinanceRoleRequired = isFinanceRoleRequired;
	}
