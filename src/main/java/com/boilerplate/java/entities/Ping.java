...
public class Ping implements Serializable {
	...
	/**
	 * This method returns the status map, which is details of individual status
	 * of each service
	 * 
	 ...
	 * @param status
	 *            The status of the servcice
	 * @param dontFailOverAllstatus
	 *            If this is false overall ping request will be marked failed
	 */
