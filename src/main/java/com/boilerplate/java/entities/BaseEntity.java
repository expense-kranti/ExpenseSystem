...
/**
 * This is the base entity of the system. All entities in the system must be
 * derived from this. All entities are expected to be serializable
 * 
 * @author gaurav
 */
public abstract class BaseEntity extends Base implements Serializable {

	@ApiModelProperty(value = "This is the id of the entity", required = true, notes = "The id is a String")
	/**
	 ...
	 * 
	 * @param stringCreationDate
	 *            the stringCreationDate to set
	 */
	...
	/**
	 * Transforms an entity into an internal entity which will be used by
	 * service layer
	 * 
	...
	/**
	 * Transforms an entity into an external entity which will be used by
	 * Controller layer
	 * 
