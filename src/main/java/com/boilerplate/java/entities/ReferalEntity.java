...
public class ReferalEntity extends BaseEntity implements Serializable{
	 ...
	 * @param referralContact The referral contacts list
	 */
	 ...
	 * @param referralMediumType The referral medium type
	 */
	 ...
	 * @param phoneNumberReferrals The phone
	 */
	 ...
	 * @param emailReferrals The email referral map
	 */
