...
@Api(value = "Diagnostic API's", basePath = "/health", description = "This has api's to check and diagnose"
...
public class HealthController extends BaseController {
	...
	/**
	 * This method is used to ping a server. This method checks all the major
	 * components like cache, queue, db etc and sends back a status for the
	 * machine
	 * 
	 ...
	 */
	@ApiOperation(value = "Returns " + "An overall status of the server health and the abillity to connect "
			+ "to other servers.")
