...
public class FeedbackController extends BaseController{
	...
	/**
	 * This method sends email on user feature selection as feedback submit by user
	 * @param feedBackEntity This contains the selected feature by user as user feedback
	...
	public @ResponseBody void sendEmailOnFeedbackSubmit(@RequestBody FeedBackEntity feedbackEntity) throws NotFoundException, ConflictException{
		feedbackService.sendEmailOnFeedbackByBackGroundJob(feedbackEntity);
	}
}
