...
public class UserController extends BaseController {
	 ...
	 *             This exception is thrown if the user name or password is blank
	 * @throws ConflictException
	 *             This exception is thrown if the user already exists in the system
	...
	public @ResponseBody Session authenticate(@RequestBody AuthenticationRequest authenticationRequest)
		...
		// add the user id for logging, we have to explictly do it here only in this
